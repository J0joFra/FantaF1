...
export default function Calculator() {
  ...
  const gap       = driver && leader && !isLeader ? leader.points - driver.points : 0;
  const eliminated =
  ...
  // Points the leader still needs to accumulate over P2 to clinch mathematically
  const clinchPoints = isLeader && drivers[1]
    ? pointsToClinch(leader.points, drivers[1].points, maxAvailable)
    : null;
          ...
          {eliminated ? (
            ...
            <>
              <ScenarioCard title="Title Clinch" icon={CheckCircle2} variant="success">
                {clinchPoints !== null && clinchPoints <= 0 ? (
                  ...
                  <>
                    <p className="text-sm">
                      Vantaggio: <strong>{gapToSecond} punti</strong> su P2.
                      Servono ancora{" "}
                      <strong>{clinchPoints}</strong> punti di margine per chiudere il titolo.
                    </p>
              ...
              <ScenarioCard title="Scenario Perfetto" icon={TrendingUp}>
                <div className="space-y-2 text-sm">
                  ...
                  <ul className="space-y-1 text-xs text-muted-foreground">
                    <li>• {racesLeft} vittorie = {racesLeft * MAX_POINTS_RACE} punti</li>
                    {sprintsLeft > 0 && (
                      <li>• {sprintsLeft} sprint vittorie = {sprintsLeft * MAX_POINTS_SPRINT} punti</li>
                    )}
