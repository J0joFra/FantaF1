...
function StatCompare({ label, val1, val2, color1, color2, lowerIsBetter = false }) {
  ...
  return (
    <div className="py-3 border-b border-border/50 last:border-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <span
          className={`font-mono text-sm font-bold w-12 ${
    ...
    <div className="space-y-5 pb-10">
      ...
      {d1 && d2 && (
        ...
        >
          ...
          <StatCompare
            label="Giri Veloci"
            val1={d1.fastest_laps}
            val2={d2.fastest_laps}
            color1={c1}
            color2={c2}
          />
          <StatCompare
